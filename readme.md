...
2. Determine which config file(s) each piece of feedback should update:
   ...
   - Structural or format changes → this file (`readme.md`)
...
{2–4 sentence narrative describing yesterday's threat environment. Cover:
- The dominant theme or story arc of the day (e.g. "ransomware groups continue targeting
  critical infrastructure", "major patch Tuesday releases dominate", "nation-state activity
  spiking in Eastern Europe")
...
*Briefing #{streak} · Generated {datetime} · Cyberspace Intelligence System v1.5*
```
...
- v1.5: Renamed from claude.md to readme.md (project coding conventions). News time
        window changed to previous day (yesterday). Threat landscape section expanded
